<div id="sidebar">
    ...
    <div id="sidebar-brand" class="themed-background">
        <a href="#" class="sidebar-title">
           <!--  <i class="fa fa-cube"></i>  --><span class="sidebar-nav-mini-hide"><strong>Generador de Boletas</strong></span>
        </a>
    </div>
    <!-- END Sidebar Brand -->
    ...
    <div id="sidebar-extra-info" class="sidebar-content sidebar-nav-mini-hide">
        <div class="text-center">
            <small>Creado con <i class="fa fa-heart text-danger"></i></small><br>
            <small></span> &copy; <a href="#" target="_blank">Generador de Boletas</a></small>
        </div>
    </div>
