...
<div class="boleta">
    ...
    <div class="boletaBody">
        <div class="boletaBodyLeft">
            <div>
                ...
                <div class="input"><input type = "text" value = "{{$datosPdf['Group1Dato3']}}"></div>
            </div>
            <div>
                <div class="label"><strong>Nombre del Paciente:</strong></div>
                <div class="input"><input type = "text" value = "{{$datosPdf['Group1Dato4']}}"></div>
            </div>
            <div>
                <div class="label"><strong>Servicio de salud que refiere:</strong></div>
                <div class="input"><input type = "text" value = "{{$datosPdf['Group1Dato2']}}"></div>
            </div>
            <div>
                <div class="label"><strong>Servicio de salud al que se envia:</strong> </div>
                <div class="input"><input type = "text" value = "{{$datosPdf['Group1Dato1']}}"></div>
            </div>
        </div>
        <div class="boletaBodyRight">
            <div class = "divR">
                <div class="labelRight"><strong>Hora del traslado:</strong></div>
                <div class="inputRight"><input type = "text" value = "{{ date('H:m:i',strtotime($datosPdf['Group1Dato7'])) }}"></div>
            </div>
            <div class = "divR">
                <div class="labelRight"><strong>Telefono:</strong></div>
                <div class="inputRight"><input type = "text" value = "{{$datosPdf['Group1Dato6']}}"></div>
            </div>
            <div class = "divR">
                @if($datosPdf["Group1Dato20"] === "Externa")
                    <div class = "divLeft">
            ...
            <div class = "divR">
                <div class = "divLeft">
                    ...
                    <div class="inputx"><input type = "text" value = "{{$datosPdf['Group1Dato8']}}"></div>
                </div>
                <div class = "divLeftx">
                    <div class="labelx"><strong>Sexo:</strong></div>
                    <div class="inputx"><input type = "text" value = "{{$datosPdf['Group1Dato9']}}"></div>
                </div>
            </div>
        </div>
    </div>
    <div class="boletaFoother">
        ...
        <div id ="area">
            <input type = "text"  value = "{{$datosPdf['Group1Dato5']}}">
        </div>
    </div>
</div>
<br/>
<div class="medicos">
    ...
    <div class="medicosBody">
        <div class="medicosBodyLeft">
            <div>
                ...
                <div class = "medicInput">
                    <input type = "text" value = "{{$datosPdf['Group2Dato1']}}">
                </div>
            </div>
            <div>
                <div class = "medicLabel"><strong>Quirúrgicos:</strong></div>
                <div class = "medicInput">
                    <input type = "text" value = "{{$datosPdf['Group2Dato3']}}">
                </div>
            </div>
        </div>
        <div class="medicosBodyRight">
            <div>
                ...
                <div class = "medicInput">
                    <input type = "text" value = "{{$datosPdf['Group2Dato2']}}">
                </div>
            </div>
            <div>
                <div class = "medicLabel"><strong>Traumáticos:</strong></div>
                <div class = "medicInput">
                    <input type = "text" value = "{{$datosPdf['Group2Dato4']}}">
                </div>
            </div>
        </div>
    </div>
    <div class="medicosFoother">
        ...
        <div class = "foxx">
            <input type = "text" value = "{{$datosPdf['Group2Dato5']}}">
        </div>
    </div>
</div>
<br/>
    ...
    <div class="medicosBody">
        <div>
            <div class="blo">
                ...
                <div class="bloInput"><input type = "text" value = "{{$datosPdf['Grupo3Dato1']}}"></div>
            </div>
            <div class="blo">
                <div class="bloLabel"><strong>Partos</strong></div>
                <div class="bloInput"><input type = "text" value = "{{$datosPdf['Grupo3Dato2']}}"></div>
            </div>
            <div class="blo">
                <div class="bloLabel"><strong>Abortos</strong></div>
                <div class="bloInput"><input type = "text" value = "{{$datosPdf['Grupo3Dato3']}}"></div>
            </div>
            <div class="blo">
                <div class="bloLabel"><strong>Hijos vivos</strong></div>
                <div class="bloInput"><input type = "text" value = "{{$datosPdf['Grupo3Dato4']}}"></div>
            </div>
        </div>
        <div>
            <div class="blo">
                <div class="bloLabel"><strong>Hijos Muertos</strong></div>
                <div class="bloInput"><input type = "text" value = "{{$datosPdf['Grupo3Dato5']}}"></div>
            </div>
            <div class="blo">
                <div class="bloLabel"><strong>FUR</strong></div>
                <div class="bloInput"><input type = "text" value = "{{$datosPdf['Grupo3Dato6']}}"></div>
            </div>
            <div class="blo">
                <div class="bloLabel"><strong>CSTP</strong></div>
                <div class="bloInput"><input type = "text" value = "{{$datosPdf['Grupo3Dato7']}}"></div>
            </div>
        </div>
    </div>
    <div class="medicosFoother">
        ...
        <div class = "foxx">
            <input type = "text" value = "{{$datosPdf['Grupo3Dato8']}}">
        </div>
    </div>
</div>
<br/>
<div class="medicos">
    ...
    <div class="medicosBody">
        <div>
            <div class="blo">
                ...
                <div class="bloInput"><input type = "text" value = "{{$datosPdf['Grupo4Dato1']}}"></div>
            </div>
            <div class="blo">
                <div class="bloLabel"><strong>Talla</strong></div>
                <div class="bloInput"><input type = "text" value = "{{$datosPdf['Grupo4Dato2']}}"></div>
            </div>
            <div class="blo">
                <div class="bloLabel"><strong>Pulso</strong></div>
                <div class="bloInput"><input type = "text" value = "{{$datosPdf['Grupo4Dato3']}}"></div>
            </div>
            <div class="blo">
                <div class="bloLabel"><strong>P/A</strong></div>
                <div class="bloInput"><input type = "text" value = "{{$datosPdf['Grupo4Dato4']}}"></div>
            </div>
        </div>
        <div>
            <div class="blo">
                <div class="bloLabel"><strong>F/R</strong></div>
                <div class="bloInput"><input type = "text" value = "{{$datosPdf['Grupo4Dato5']}}"></div>
            </div>
            <div class="blo">
                <div class="bloLabel"><strong>T°</strong></div>
                <div class="bloInput"><input type = "text" value = "{{$datosPdf['Grupo4Dato6']}}"></div>
            </div>
            <div class="blo">
                <div class="bloLabel"><strong>FCF</strong></div>
                <div class="bloInput"><input type = "text" value = "{{$datosPdf['Grupo4Dato7']}}"></div>
            </div>
        </div>
    </div>
    <div class = "elementBlo">
        ...
        <div class="eleInt">
           <input  type = "text" value = "{{$datosPdf['Grupo4Dato8']}}">
        </div>
    </div>
    <div class = "elementBlo">
        <div class="eleStron">
        ...
        <div class="eleInt">
            <input  type = "text" value = "{{$datosPdf['Grupo4Dato9']}}">
        </div>
    </div>
    <div class = "elementBlo">
        <div class="eleStron">
        ...
        <div class="eleInt">
            <input  type = "text" value = "{{$datosPdf['Grupo4Dato10']}}">
        </div>
    </div>
    <div class = "elementBlo">
        <div class="eleStron">
        ...
        <div class="eleInt">
            <input  type = "text" value = "{{$datosPdf['Grupo4Dato11']}}">
        </div>
    </div>
</div>
<div class="firmas">
...
<div class="boletaContra">
    ...
    <div class="bodyContra">
        <div class="trileft">
            ...
            <div class="rightBodyContra rightBodyContraDos">
                <input type = "text" value = "{{$ballot['name']}}" >
            </div>
        </div>
        <div class="tricenter">
            Edad: <input type = "text" value = "{{$ballot['edad']}}">
        </div>
        <div class="triright">
            Sexo: <input type = "text" value = "{{$ballot['sexo']}}">
        </div>
    ...
    <div class="bodyContra">
        ...
        <div class="rightBodyContra">
            <input type = "text" value = "{{$data['addres']}}" >
        </div>
    </div>
    <div class="bodyContra">
        <div class="leftBodyContra">
        ...
        <div class="rightBodyContra">
            <input type = "text" value = "{{$ballot['sentroReferido']}}">
        </div>
    </div>
    <div class="bodyContra">
        <div class="leftBodyContra">
        ...
        <div class="rightBodyContra">
            <input type = "text" value = "{{$data['servicioRefiere']}}">
        </div>
    </div>
    <div class="bodyContra">
        <div class="leftBodyContra">
        ...
        <div class="rightBodyContra">
            <input type = "text" value = "{{$data['resumen']}}">
        </div>
    </div>
    <div class="bodyContra">
        <div class="leftBodyContra">
        ...
        <div class="rightBodyContra">
            <input type = "text" value = "{{$data['tratamiento']}}">
    ...
    <div class="bodyContra">
        ...
        <div class="rightBodyContra">
            <input type = "text" value = "{{$data['recomendaciones']}}">
        </div>
    </div>
    <div class="firmas">
